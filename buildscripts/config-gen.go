...
var configTemplate = `// --------  DO NOT EDIT --------
// This file is autogenerated by config-gen.go during the release process.
...
// genConfig generates ‘config.go’.
func genConfig(version string) {
	t := template.Must(template.New("config").Parse(configTemplate))
	configFile, e := os.OpenFile("config.go", os.O_WRONLY|os.O_CREATE|os.O_TRUNC, 0600)
	if e != nil {
		fmt.Printf("genconfig: Unable to generate ‘config.go’. Error: %s.\n", e)
		os.Exit(1)
	}
	defer configFile.Close()

	e = t.Execute(configFile, struct {
		Version    string
		ReleaseTag string
		CommitID   string
